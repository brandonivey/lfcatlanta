...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'feeds_feed', (
            ...
            ('last_polled', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table(u'feeds_feedlist')
    ...
    models = {
        ...
        u'feeds.feed': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_polled': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'url': ('django.db.models.fields.URLField', [], {'unique': 'True', 'max_length': '200'})
        },
        u'feeds.feedlist': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'FeedList', '_ormbases': [u'pages.Page']},
